...
namespace DAL
{
    public class SQLHelpDataWMS
    {
        private const string sErrCode = "错误代码:DA002";
        private ConfigApp configApp = new ConfigApp(AppDomain.CurrentDomain.BaseDirectory + @"LinkDataBaseWMS.config");
